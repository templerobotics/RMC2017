...
#Initialize a wavePWM object which runs the wave
MOTOR_CONTROL_WAVE = wavePWM.PWM(PIGPIO_DAEMON)
MOTOR_CONTROL_WAVE.set_cycle_time(3000)

isCleaned = False

def cleanup():
    for pin in USED_PINS:
        MOTOR_CONTROL_WAVE.set_pulse_length_in_micros(pin, 1500)
    MOTOR_CONTROL_WAVE.cancel()
    isCleaned = True
